package org.example.parking_service.config;
...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, CheckoutEvent> eventProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, CheckoutEvent> eventKafkaTemplate() {
